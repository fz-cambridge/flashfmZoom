...
There are three different options of using this tool: *online*, *cloud* and *local*. This section explains the implementation steps and potential limitations of each option. The online version is the most convenient option for users to experience and interact with this tool, but due to the limit of memory size (i.e. a maximum of 8GB) in R [Shinyapps.io](https://www.shinyapps.io)...
